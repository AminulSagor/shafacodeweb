...
export default function Home() {
  ...
  <div className="container hero-content">
    ...
    <div className="hero-cta">
      <Link to="/contact" className="btn btn-primary" aria-label="Contact ShafaCode">
  ...
  <div className="container contact-inner">
    ...
    <div className="contact-grid">
      ...
      <div className="contact-info">
        ...
        <p>
          <strong>Email:</strong>
          <a href="mailto:hello@shafacode.com"> hello@shafacode.com</a>
        </p>
        <p>
          <strong>WhatsApp:</strong>
          <a href="https://wa.me/8801234567890" target="_blank" rel="noopener noreferrer"> Chat on WhatsApp
          </a>
        </p>
        <p>
          <strong>LinkedIn:</strong>
          <a href="https://linkedin.com/company/shafacode" target="_blank" rel="noopener noreferrer"> Linkedin
          </a>
        </p>
        <p>
          <strong>Facebook:</strong>
          <a href="https://facebook.com/shafacode" target="_blank" rel="noopener noreferrer"> Facebook
          </a>
        </p>
